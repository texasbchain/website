...
//   const [name, setName] = useState('Roshan Rajan');
//   const [job, setJob] = useState('President of Engineering');
//   const [about, setAbout] = useState('Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. I am interested in blockchain technology. You might find me eating blocks.')
...
//               <p className="pgraph_about">At Texas Blockchain,  
//               <a className="link" href="/about"> our team</a> is building the next generation of innovators. 
//               We lead a community focused on the discussion and development of blockchain technology. We want to eventually get people from all walks of life to get into crypto and help bring our decentralized future into fruition where each person has true sovereignty over their data, their finance, and ultimately their life.</p>
//               <h3>WHAT WE DO</h3>
//               <p><a className="bold">We empower.</a> Providing members with opporunities to learn not only about the technical side of crypto but also the financial applications.</p>
//               <p><a className="bold">We create.</a> All activities at Texas Blockchain are centered around nurturing the innovative ideas that our members have.</p>
//             </div>
//             <div className="btn-placement">
//               <button className="sbtn">BY THE NUMBERS</button>
//               <button className="sbtn">CONTACT US</button>
//             </div>
//           </div> 
//           <Timeline/>
//           <h1 className='title'>Our Team</h1>
